...
bool validatePaymentParams(PaymentParams paymentParams, {bool debugPrint: true}) {
  ...
  if (paymentParams.udf1 == null) {
    if (debugPrint) print(Constants.printTAG + "udf1 cannot be null. Must be initialised with \"\" ");
    return false;
  }
  if (paymentParams.udf2 == null) {
    if (debugPrint) print(Constants.printTAG + "udf2 cannot be null. Must be initialised with \"\" ");
    return false;
  }
  if (paymentParams.udf3 == null) {
    if (debugPrint) print(Constants.printTAG + "udf3 cannot be null. Must be initialised with \"\" ");
    return false;
  }
  if (paymentParams.udf4 == null) {
    if (debugPrint) print(Constants.printTAG + "udf4 cannot be null. Must be initialised with \"\" ");
    return false;
  }
  if (paymentParams.udf5 == null) {
    if (debugPrint) print(Constants.printTAG + "udf5 cannot be null. Must be initialised with \"\" ");
    return false;
  }
  if (paymentParams.udf6 == null) {
    if (debugPrint) print(Constants.printTAG + "udf6 cannot be null. Must be initialised with \"\" ");
    return false;
  }
  if (paymentParams.udf7 == null) {
    if (debugPrint) print(Constants.printTAG + "udf7 cannot be null. Must be initialised with \"\" ");
    return false;
  }
  if (paymentParams.udf8 == null) {
    if (debugPrint) print(Constants.printTAG + "udf8 cannot be null. Must be initialised with \"\" ");
    return false;
  }
  if (paymentParams.udf9 == null) {
    if (debugPrint) print(Constants.printTAG + "udf9 cannot be null. Must be initialised with \"\" ");
    return false;
  }
  if (paymentParams.udf10 == null) {
    if (debugPrint) print(Constants.printTAG + "udf10 cannot be null. Must be initialised with \"\" ");
    return false;
  }
